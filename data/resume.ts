...
export const resumeData = {
  ...
  projects: [
    ...
    },
    {
      ...
      category: "产品",
      thumbnailUrl: "/assets/images/thumb-inview.jpg",
      challenge: "传统定点摄像头被动录像，巡检覆盖不足、响应滞后，安全隐患往往在事后才被发现；人工审看视频耗时耗力，无法支撑大规模工地的实时安全管理。",
      solution: "通过个性化轮巡计划与图生文大模型分析，将传统定点摄像头升级为智能感知节点，实现对关键区域的无人化自动巡检、安全隐患智能识别与多维报告生成。系统自动排查人员、物体、环境三类安全隐患，并输出结构化巡检报告。",
      impact: "已落地蕃瓜弄小区旧住房改建工程等项目，全面提升工地管理的精准性与自动化水平，有效弥补人工巡检覆盖不足、响应滞后的短板。",
      description: "将施工现场摄像头升级为 AI 巡检节点：个性化轮巡计划 + 图生文大模型驱动，自动完成人员、物体、环境安全隐患排查，输出多维巡检报告，替代人工视频审看。",
      tags: ["总承包数字化赋能", "多源感知融合"],
      demoUrl: "https://fgn.invix.tech/#/home",
      type: "iframe",
    },
  ],
  publications: [
